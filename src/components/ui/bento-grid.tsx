        ...
        background: (
            <Command className="absolute right-10 top-10 w-[70%] origin-to translate-x-0 border border-border transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_40%,#000_100%)] group-hover:-translate-x-10 p-2">
                ...
                <div className="mt-1 cursor-pointer">
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Nodify.in/hdf00c</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Nodify.in/sdv0n0</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Nodify.in/03gndo</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Nodify.in/09vmmw</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Nodify.in/s09vws</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Nodify.in/sd8fv5</div>
                </div>
            </Command>
        ),
    },
